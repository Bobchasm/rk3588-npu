...
using TokensToHiddenRequest = distributed::TokensToHiddenRequest;
using TokensToHiddenResponse = distributed::TokensToHiddenResponse;
using StageForwardRequest = distributed::StageForwardRequest;
using StageForwardResponse = distributed::StageForwardResponse;
using HiddenToTokenRequest = distributed::HiddenToTokenRequest;
using HiddenToTokenResponse = distributed::HiddenToTokenResponse;
